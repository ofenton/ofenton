...
public final class MapReduceExecutor {
  ...
  public List<KeyValue> execute(Program program, List<KeyValue> inputData) {
    ...
    Collector mapCollector = new Collector() {
      @Override
      public void write(String key, String value) {
        mapOutput.add(new KeyValue(key, value));
      }
    };
    ...
    Collector reduceCollector = new Collector() {
      @Override
      public void write(String key, String value) {
        reduceOutput.add(new KeyValue(key, value));
      }
    };
